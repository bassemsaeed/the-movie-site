...
const MediaCard = ({ item, onRemove, navigate, lang }) => {
  ...
  return (
    <div
      key={item.id}
      className="relative rounded-lg overflow-hidden shadow-lg bg-gray-200 dark:bg-neutral-800 aspect-[2/3] cursor-pointer"
      
      onMouseEnter={() => setIsOverlayVisible(true)}
      onMouseLeave={() => setIsOverlayVisible(false)}

      // For Mobile: A tap ONLY shows the overlay. It does NOT toggle.
      ...
      >
        ...
        <div className="flex justify-between items-end gap-2">
          ...
          <button
            onClick={(e) => {
              e.stopPropagation(); 
              navigate(`/${mediaType}/${item.id}${lang === "ar" ? "?l=ar" : ""}`);
            }}
